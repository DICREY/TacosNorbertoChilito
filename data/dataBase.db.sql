...
CREATE TABLE PERSONAS (
	...
	ema_usu CHAR(100) NOT NULL,
	dir_usu CHAR(100),
	pais_usu CHAR(100) NOT NULL,
	ciud_usu CHAR(100) NOT NULL,
	estado BOOLEAN NOT NULL
);

CREATE TABLE EMPLEADOS(
	id_usu INT PRIMARY KEY NOT NULL, INDEX(id_usu),FOREIGN KEY(id_usu) REFERENCES PERSONAS(id_usu) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE CLIENTES (
	id_usu INT PRIMARY KEY,INDEX(id_usu),FOREIGN KEY(id_usu) REFERENCES PERSONAS(id_usu) ON DELETE CASCADE ON UPDATE CASCADE,
	ano_cli CHAR(100) NOT NULL,
	depart_usu CHAR(100) NOT NULL DEFAULT("BOGOTA")
);

CREATE TABLE DISTRIBUIDORES (
	id_usu INT PRIMARY KEY,INDEX(id_usu),FOREIGN KEY(id_usu) REFERENCES PERSONAS(id_usu), ON UPDATE CASCADE ON DELETE CASCADE
);
