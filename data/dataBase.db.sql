...
CREATE TABLE EXISTENCIAS_MAQUINARIA (
    id_exi_maq INT AUTO_INCREMENT PRIMARY KEY,
    can_exi_maq INT NOT NULL DEFAULT(0),
    id_maq INT NOT NULL, INDEX(id_maq),FOREIGN KEY (id_maq) REFERENCES MAQUINARIA(id_maq) ON DELETE CASCADE ON UPDATE CASCADE
);
