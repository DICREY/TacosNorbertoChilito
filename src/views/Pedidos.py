...
class Pedidos(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.fechaL = ctk.CTkLabel(self.fechaF, text="Fecha", text_color=btnCafe,font=letter2,anchor="center", fg_color="transparent",bg_color="transparent",)
        ...
        self.clienteL = ctk.CTkLabel(self.clienteF, text="Cliente", text_color=btnCafe, font=letter2,anchor="center", fg_color="transparent", bg_color="transparent")
        ...
        self.celL = ctk.CTkLabel(self.celF, text="Celular", font=letter2, text_color=btnCafe, anchor="center", fg_color="transparent", bg_color="transparent")
        ...
        self.estadoL = ctk.CTkLabel(self.estadoF, text="Estado", font=letter2, text_color=btnCafe, anchor="center", fg_color="transparent", bg_color="transparent")
        ...
        text_color=btnCafe, anchor="center", fg_color="transparent", bg_color="transparent")
        ...
        self.obserL = ctk.CTkLabel(self.obserF, text="Observación", text_color=btnCafe, font=letter2,anchor="center", fg_color="transparent", bg_color="transparent")
